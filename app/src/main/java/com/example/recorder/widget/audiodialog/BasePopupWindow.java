...
public class BasePopupWindow extends PopupWindow {
    ...
    /**
     * Initialize some information for BasePopupWindow
     */
...
//        setWidth(ViewGroup.LayoutParams.WRAP_CONTENT);
        setHeight(ViewGroup.LayoutParams.WRAP_CONTENT);
        setWidth(ViewGroup.LayoutParams.WRAP_CONTENT);
        setOutsideTouchable(false);  //Default setting for no response when clicking outside
        setFocusable(true);
    }
    ...
    /**
     * Window Hidden, Window Background Transparency Gradient Animation
     */
    ...
    /**
     * Control the opacity of the window background
     */
    ...
    /**
     * Add an external click event to the form
     */
